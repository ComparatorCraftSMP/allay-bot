...
import { VectorStoreToolkit, createVectorStoreAgent, type VectorStoreInfo } from 'langchain/agents';
...
export class UserEvent extends Listener<typeof Events.MessageCreate> {
	public override async run(msg: Message) {
		...
		const loader = new GithubRepoLoader('https://github.com/PaperMC/docs/tree/main/docs', {
			branch: 'main',
			recursive: false,
			ignoreFiles: ['LICENSE', 'LICENSE-docs', '.yarn', '.devcontainer', 'config', 'src', '.gitignore']
		});
